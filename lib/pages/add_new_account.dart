                      ...
                      children: <Widget>[
                        Image.asset(
                          ...
                          Container(
                             ...
                             child: Text(map["name"],style:TextStyle(color:Theme.of(context).colorScheme.tertiary,))),
                                 ],
                                      ),
                                    );
                                  }).toList(),
                    ...
                    DropdownButtonFormField(
                      ...
                      items: typeAccounts.map((Map map) {
                        return DropdownMenuItem<String>(
                          ...
                          child: Container(
                                  margin: const EdgeInsets.only(left: 10),
                                  child: Text(map["type"],style:TextStyle(color:Theme.of(context).colorScheme.tertiary,))),
